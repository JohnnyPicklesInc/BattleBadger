...
// The shipped factions, as importable rulesets. Plain data, and the editor's
// starter library — see mapgen/factions/library.ts.
export { BUILTIN_RULESETS } from './mapgen/factions/library.ts'
...
export * from './systems/gates.ts'
export * from './systems/upgrades.ts'
